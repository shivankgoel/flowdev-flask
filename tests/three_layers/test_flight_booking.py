import json
from . import run_async_test, create_test_agent, get_flight_booking_three_layers

def test_flight_booking_three_layers():
    """Test generating code for three-layer flight booking system"""
    agent = create_test_agent()
    layers = get_flight_booking_three_layers()
    ...
    assert layer_order == [1, 2, 3]  # Verify correct order
    
    return results

if __name__ == "__main__":
    test_flight_booking_three_layers() 